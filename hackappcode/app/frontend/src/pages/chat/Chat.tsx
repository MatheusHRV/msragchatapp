                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>CHEFBOT</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Pergunte como fazer alguma receita ou selecione um exemplo</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Pergunte (Ex. Como fazer bolinho de arroz?)"
                            disabled={isLoading}
