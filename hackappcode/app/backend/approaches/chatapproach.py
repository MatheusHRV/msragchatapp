...
class ChatApproach(Approach, ABC):
    ...
    query_prompt_few_shots = [
        {"role": USER, "content": "Como fazer farófa de banana?"},
        {"role": ASSISTANT, "content": "Explique como fazer uma farófa de banana"},
        {"role": USER, "content": "Não tenho calabresa para a feijoada, posso substituir?"},
        {"role": ASSISTANT, "content": "Sugira outro ingrediente que possa substituir a calabresa na feijoada"},
    ]
    NO_RESPONSE = "0"

    follow_up_questions_prompt_content = """Tente gerar 2 breves sugestões de variação da receita que o usuário solicitou, com usos criativos dos ingredientes ou adições que possam tornar a receita mais gostosa.
   Se você não souber nenhuma variação para a receita solicitada, não gere sugestões.
    """
    ...
    If the question is in English, translate to Portuguese before generating the search query.
    Do not translate recipe titles.
